...
const AllTheBooks = () => {
  ...
  const filteredBooks = selectedGenre === "all" ? shuffleArray(booksData) : booksData.filter(book => book.category === selectedGenre);


  const offerBooks = shuffleArray(booksData).slice(0, 9);

  return (
    <Container fluid>
  
  <Carousel style={{ marginBottom: '20px', height: '400px' }}>
